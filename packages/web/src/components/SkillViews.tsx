...
export function SkillCard({ skill, onOpen }: Props) {
  return (
    <button
      onClick={onOpen}
      className="flex h-44 flex-col gap-2 rounded-xl border border-stone-200 bg-white p-4 text-left transition hover:border-indigo-400 hover:shadow-md dark:border-stone-800 dark:bg-stone-900 dark:hover:border-indigo-500"
    >
